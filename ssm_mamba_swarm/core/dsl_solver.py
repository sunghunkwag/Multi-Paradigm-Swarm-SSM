"""DSL Solver — ported directly from heterogeneous-agent-swarm.

Symbolic solver for ARC tasks: searches for DSL compositions
(up to max_depth=2 composition chains) that solve all training examples.
"""
import numpy as np
