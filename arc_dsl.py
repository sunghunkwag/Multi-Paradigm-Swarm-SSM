"""ARC DSL — ported directly from heterogeneous-agent-swarm.

Domain Specific Language for ARC tasks: 24 grid primitives
(rotations, flips, cropping, gravity, sorting, color ops, etc.)
"""
import numpy as np
...
class ARCDSL:
    ...
    Contains 24 primitives for manipulating 2D grids.
    """
