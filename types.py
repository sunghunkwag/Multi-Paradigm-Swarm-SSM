"""Core types — ported directly from heterogeneous-agent-swarm.

Contains: Proposal, EncodedState, StateVectorProvider, AgentConfig.
"""
...
@dataclass
class Proposal:
    action_type: str        # Maps to tool_name (run_tests, write_patch, summarize, wait, etc.)
